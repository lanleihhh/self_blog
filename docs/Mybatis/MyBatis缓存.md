...
<img src="../img/image-20220812130835281.png" alt="image-20220812130835281" style="zoom: 67%;" />
...
<img src="../img/image-20220812132324343.png" alt="image-20220812132324343" style="zoom: 50%;" />
...
1. **close()关闭SqlSession (BaseExcutor)**
   ...
   <img src="../img/image-20220812131305745.png" alt="image-20220812131305745" style="zoom:50%;" />

2. **commit 提交(BaseExcutor)**

   <img src="../img/image-20220812131333150.png" alt="image-20220812131333150" style="zoom:50%;" />


3. **rollback 回滚** 

   <img src="../img/image-20220812131437557.png" alt="image-20220812131437557" style="zoom:50%;" />

4. **clearLocalCache()**

   <img src="../img/image-20220812131517301.png" alt="image-20220812131517301" style="zoom:50%;" />

5. **update、insert、delete 操作** ,update调用了clearLocalCache()，insert和delete都是调用update方法来执行的

   <img src="../img/image-20220812131642807.png" alt="image-20220812131642807" style="zoom:50%;" />

   <img src="../img/image-20220812131702829.png" alt="image-20220812131702829" style="zoom: 67%;" />

   <img src="../img/image-20220812131740135.png" alt="image-20220812131740135" style="zoom:80%;" />
...
2.  **传递给查询SQL的参数必须相同**，否则无法命中缓存
   ...
   <img src="../img/image-20220811142247160.png" alt="image-20220811142247160" style="zoom:33%;" />

3.  **分页参数必须相同**，否则无法命中缓存，缓存的粒度是整个分页查询结果，不是结果中的每个对象

4. **要求传递给JDBC的SQL语句是完全相同的**

   <img src="../img/image-20220812130547910.png" alt="image-20220812130547910" style="zoom:50%;" />

5. **要求执行环境相同**

   <img src="../img/image-20220812130622420.png" alt="image-20220812130622420" style="zoom:50%;" />

命中原则的源码:BaseExcutor中的createCacheKey方法

<img src="../img/image-20220812131002988.png" alt="image-20220812131002988" style="zoom:50%;" />
...
<img src="../img/image-20220812140854983.png" alt="image-20220812140854983" style="zoom: 50%;" />
...
<img src="../img/image-20220812154857893.png" alt="image-20220812154857893" style="zoom:80%;" />
